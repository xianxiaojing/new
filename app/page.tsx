...
const projects = [
  {id:"01",title:"核心借款链路体验升级",subtitle:"用流程重构推动信贷转化",metric:"11.3% → 22.14%",tag:"信贷转化 · 2022",image:"/works/loan-flow.png",fullImage:"/cases/01-loan.png",brief:"将输入金额、选择期数、确认借款三步合并为一步决策；金额默认展示系统最高可借额度，期数变化时利率与还款信息实时反馈。",role:"交互流程优化、数据建设",result:"同口径下，提交借款转化率由 11.3% 提升至 22.14%。"},
  {id:"02",title:"拒量导流授信流程优化",subtitle:"承接被拒用户的二次价值",metric:"累计 +7.11pp",tag:"授信承接 · 2024",image:"/works/credit-routing.png",fullImage:"/cases/02-credit.png",brief:"在明确第三方服务主体与个人信息授权的前提下，复用已有资料，仅展示仍需补充的信息，并重构为两组连续表单。",role:"交互流程优化",result:"1.0 表单优化提升 4.46pp；2.0 新增补充授信入口再提升 2.65pp。"},
...
export default function Home(){
  ...
  return <main style={{"--progress":scroll} as React.CSSProperties}>
    ...
    <header><a className="brand" href="#top">ZXJ<span>®</span></a><nav><a href="#about">关于</a><a href="#experience">经历</a><a href="#works">项目</a><a href="/resume">个人履历</a></nav><a className="contact" href="tel:13051328631">联系我 ↗</a></header>
