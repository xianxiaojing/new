...
export default function Home(){
  ...
  return <main style={{"--progress":scroll} as React.CSSProperties}>
    ...
    <header><a className="brand" href="#top">ZXJ<span>®</span></a><nav><a href="#about">关于</a><a href="#experience">经历</a><a href="#works">项目</a><a href="/resume">工作经历</a></nav><a className="contact" href="tel:13051328631">联系我 ↗</a></header>
